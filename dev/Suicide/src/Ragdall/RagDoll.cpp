...
const float RagDoll::RAG_DALL_SCALE = 0.8f;
...
: m_ownerWorld (ownerWorld)
{
    ...
    localA.setIdentity(); localB.setIdentity();
    localA.getBasis().setEulerZYX(0,0,M_PI_2); localA.setOrigin(btVector3(btScalar(0.), btScalar(30), btScalar(0.))*RAG_DALL_SCALE);
    ...
    localA.setIdentity(); localB.setIdentity();
    localA.getBasis().setEulerZYX(0,0,-M_PI_4*5); localA.setOrigin(btVector3(btScalar(-18), btScalar(-10), btScalar(0.))*RAG_DALL_SCALE);
    ...
    localA.setIdentity(); localB.setIdentity();
    localA.getBasis().setEulerZYX(0,0,M_PI_4); localA.setOrigin(btVector3(btScalar(18), btScalar(-10), btScalar(0.))*RAG_DALL_SCALE);
    ...
    localA.setIdentity(); localB.setIdentity();
    localA.getBasis().setEulerZYX(0,0,M_PI); localA.setOrigin(btVector3(btScalar(-20), btScalar(15), btScalar(0.))*RAG_DALL_SCALE);
    ...
    localA.setIdentity(); localB.setIdentity();
    localA.getBasis().setEulerZYX(0,0,0); localA.setOrigin(btVector3(btScalar(20), btScalar(15), btScalar(0.))*RAG_DALL_SCALE);
    localB.getBasis().setEulerZYX(0,0,M_PI_2); localB.setOrigin(btVector3(btScalar(0.), btScalar(-18), btScalar(0.))*RAG_DALL_SCALE);
